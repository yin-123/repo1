    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <div class="input-group">
                ...
                <select class="form-control" name="txt_search_statu" id = "txt_search_statu">
                    <option value="0">---请选择---</option>
                    <c:forEach items="${type2List }" var="r">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form id="form_user" method="post" action="reserveAdvert.htm">
                    ...
                    <table style="border-collapse:separate; border-spacing:0px 10px;">
                        ...
                        <tr>
                            ...
                            <td>广告状态：</td>
                            <td>
                                <select class="form-control" name="statu" id = "statu" aria-required="true" required>
                                    <option value="">---请选择---</option>
...
<div class="modal fade" id="modal_user_zhu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<script src="${path }/resources/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.js?1"></script>
...
<script type="text/javascript">
    ...
    function initEditUser(getSelection){
        ...
        $('#img').val(getSelection.img);
        $('#path').val(getSelection.path);
        $('#tid').val(getSelection.tid);
        $('#statu').val(getSelection.statu);
    }
    ...
    $("#btn_bar").click(function () {
        ...
        $('#modal_user_zhu').modal({backdrop: 'static', keyboard: false});
        $('#modal_user_zhu').modal('show');
