    ...
    <div class="row">
        <div class="col-lg-2">
            <div class="input-group">
                ...
                <input type="text" name="name" class="form-control" id="txt_search_phone" >
            </div>
        </div>
        <div class="col-lg-2">
            <div class="input-group">
            ...
            <div class="modal-body">
                <form id="form_user" method="post" action="reserveSchool.htm">
                    ...
                    <table style="border-collapse:separate; border-spacing:0px 10px;">
                        ...
                        <tr>
                            <td colspan="2">是否运营：</td>
                            <td colspan="3">
                                <input type="radio" name="status" class="status" value="营业"
                                       aria-required="true" required>是
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="status" class="status" value="倒闭"
                                       aria-required="true" required>否
                            </td>
                        </tr>
                    </table>
...
<div class="modal fade" id="modal_add_city" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
    <div class="modal-dialog">
        <form id="form_add_city" method="post" action="sendMsg.htm">
        <div class="modal-content">
            <div class="modal-header">
                <table style="border-collapse:separate; border-spacing:0px 10px;">
                    <tr>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger"  id="add_city_btn">添加</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
            </div>
        </div>
        </form>
...
<script type="text/javascript">
    ...
    $("#btn_city").click(function () {
        $('#modal_add_city').modal({backdrop: 'static', keyboard: false});
        $("#modal_add_city").show();
    })
